import { Work } from "@/types/work_types"
import Image from "next/image"

export const Work: React.FC<Work> = ({ work }) => (
  <section className="tw-text-white tw-min-h-screen tw-w-full tw-flex tw-flex-col lg:tw-flex-row">
    ...
    <div className="tw-w-full tw-h-[30vh] lg:tw-h-auto tw-flex tw-justify-center tw-items-center">
      <div>
        ...
        <div className="tw-text-4xl md:tw-text-5xl tw-font-semibold"><a href={work.link} target="_blank"><span className="tw-underline tw-underline-offset-2 hover:tw-underline-offset-8">{work.brand}</span></a>{work.sentence2}</div>
      </div>
    </div>
